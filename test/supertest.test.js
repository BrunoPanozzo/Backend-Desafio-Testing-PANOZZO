...
describe('Testing de API Ecommerce', () => {
    ...
    describe('Tests de USERS/PRODUCTS', () => {
        ...
        it('debe eliminar un producto', async () => {
            ...
            //verify that does not exits
            console.log(getAllRequestStatus.body.payload.docs)
            const deletedProduct = getAllRequestStatus.body.payload.find(p => p._id === productId.toString())
